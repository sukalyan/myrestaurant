	...
	<div id="scroller">
			<div id="container">
						...
						<div id="content" style="font-size:20px; font-family:'Times New Roman', Times, serif; padding:5px; ">
									...
									<br />
									<br />
								 	<form name="businessform" method="post" action="submit1.php">
									<p><input type="text" placeholder="Name" name="name"></p>
									<p><input type="text" placeholder="Another Question" name="question2" autofocus></p>

<p><input type="text" placeholder="One more Question" name="question3" autofocus></p>
<p><input type="text" placeholder="First name" name="fname" autofocus></p>
<p><input type="text" placeholder="Age" name="age" autofocus></p>
<p><input type="text" placeholder="State" name="state" autofocus></p>
<p><input type="text" placeholder="Country" name="country" autofocus></p>

<p><input type="text" placeholder="Your E-mail" name="email" autofocus></p>
	</form>								 
