...
<div id="wrapper">
	<div id="scroller">	
			<div id="container" style="padding-top:20px;">
						...
						You could promote your business with us for less than $10 per month
Fill out this form and receive more details to see how thousands of Lucky Dippers could be sent your way every single week 
									<br />
									<form name="businessform" method="post" action="submit.php">
									<p><input type="text" placeholder="Name" name="name"></p>
<p><input type="text" name="website" value="Website" ></p>
<p><input type="text" name="email" value="E-mail" ></p>
<p><textarea name="detail" placeholder="About Your Business"></textarea></p>
