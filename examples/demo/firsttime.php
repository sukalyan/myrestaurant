...
if (!isset($_COOKIE["cookie"]))
  {
 setcookie("cookie[one]",$uid,time()+3600*24*365*50);
	...
	<div id="scroller">
			<div id="container" style="padding-top:20px;">
                    ...
                    <div style="width:70%; height:30px; padding-top:10px; background:url(images/repeat1.png) repeat-x; margin:auto; color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:15px; text-align:center; font-weight:bold; ">
						...
						<div id="content" style="font-size:20px; font-family:'Times New Roman', Times, serif; padding:5px; margin-bottom:20px;">
						Welcome to <strong>"My Thinking Cap" </strong>. This page will only display once. So please read carefully to see what <strong> My Thinking Cap </strong> has to offer you. 
						<br />
						<br />
									To learn about how My Thinking Cap Works click on the <strong>ABOUT</strong> button at the bottom of the screen.
									<br /> <br />
									To submit an Idea to us so that others can scratch their head over it, click the <strong> SUBMIT</strong> button at the bottom of every screen.
									<br /> <br />
									To find out how you can Promote Your Business with us click on the <strong> BUSINESS</strong> button at the end of every screen.
						</div>
