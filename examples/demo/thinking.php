...
$q=mysql_query("select `no_of_attempts`,`ques_ids` from `user` where `id`='$u_id'") or die(mysql_error());
...
mysql_query("update `user` set `no_of_attempts`='$attempts',`ques_ids`='$tot_ques_id' where `id`='$u_id'") or die(mysql_error());
