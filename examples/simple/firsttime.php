	...
	<div id="scroller">
			<div id="container" style="padding-top:20px;">
                    ...
                    <div style="width:70%; height:30px; padding-top:10px; background:url(images/repeat1.png) repeat-x; margin:auto; color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:15px; text-align:center; font-weight:bold; ">
						...
						Welcome to <span style="color:#CCCC00;"><strong>"My Thinking Cap" </strong></span>. This page will only display once. So please read carefully to see what <strong> My Thinking Cap </strong> has to offer you. 
						<br />
						<br />
									To learn about how My Thinking Cap Works click on the <span style="color:#CCCC00;"><strong>ABOUT</strong></span> button at the bottom of every screen.
									<br /> <br />
									To submit an Idea to us so that others can scratch their head over it, click the <span style="color:#CCCC00;"><strong> SUBMIT</strong></span> button at the bottom of every screen.
									<br /> <br />
