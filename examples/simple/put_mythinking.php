...
This Lucky Dip has been viewed <?php echo $r1['viewed'];?> times
</div>
</div>
...
<div style=" height:auto; width:98%; float:left; padding:1%; margin-top:3%; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold;  line-height:1.5; background:url(images/tcrepeat1.png) repeat;   border-radius:3px; -moz-border-radius:3px; ">
																																						<p id="q1" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#8AE4EE;"><?php echo $r1['question1'];?></p>
																																												<p id="q2" style="font-size:16px; font-family:Arial, Helvetica, sans-serif;  color:#8AE4EE;"><?php echo $r1['question2'];?></p>
																																												<p id="q3" style="font-size:16px; font-family:Arial, Helvetica, sans-serif;  color:#8AE4EE;"><?php echo $r1['question3'];?></p>
...
<tr>
<td align="center" ><a href="put_mythinking.php?ld=<?php echo "$id";?>&qno=<?php echo $r1['id'];?>"><input type="button" name="btn1" value="Dip Again" class="button2" onClick="document.location.reload(true)"></a></td>
</tr>
<tr>
<td align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;  font-weight:bold;color:#B6F02F;">If you are going to research this now, take note of the questions before clicking</td>
</tr>
<tr>
<td align="center" ><a href="thinking.php?ld=<?php echo $r1['id'];?>"><button name="btn" class="button2" onClick="document.location.reload(true)">  Apply<br/>Thinking Cap </button></a></td>
</tr>
<tr>
